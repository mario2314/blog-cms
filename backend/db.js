...
if (!settingsColumns.includes("hero_image")) {
  db.exec("ALTER TABLE settings ADD COLUMN hero_image TEXT");
  console.log("Kolom hero_image ditambahkan ke tabel settings");
}
...
if (!existingSettings) {
  db.prepare(
    "INSERT INTO settings (id, site_name, hero_eyebrow, hero_title, hero_subtitle, hero_image, story, footer_text, socials) VALUES (1, ?, ?, ?, ?, ?, ?, ?, ?)"
  ).run(
    "Rasa Nusantara",
    "warung digital",
