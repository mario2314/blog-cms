...
export default function PostDetail() {
  ...
  usePageMeta({
    ...
    canonical: post ? `http://localhost:4173/post/${post.slug}` : undefined,
  });
    ...
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <p className="font-body text-primary">
          ...
          <Link to="/" className="text-secondary hover:underline">Kembali ke beranda</Link>
        </p>
      </div>
    );
  }
  ...
  return (
    <>
      <article className="container mx-auto max-w-3xl px-4 py-14">
        {post.category && (
          <span className="inline-block rounded-full bg-secondary px-3 py-1 font-body text-xs font-semibold text-white">
            {post.category}
          </span>
        )}
        ...
        <div
          className="prose prose-headings:font-body prose-p:font-body prose-p:font-light max-w-none pt-8"
